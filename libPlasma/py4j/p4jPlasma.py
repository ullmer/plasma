...
class p4jPlasma:
  ...
  def pCreateHose(self, hoseName, plasmaAddress):
    ...
    except Exception as e: self.err("pCreateHose:", e.getMessage()); return None
    return ph
  ...
  def getPlasmaAddress(self):
    ...
    except Exception as e: self.err("getPlasmaAddress:", e.getMessage()); return None
    return pa
  ...
  def pDeposit_StrStr(self, a, b):
    ...
    except Exception as e: self.err("pDeposit_StrStr:", e.getMessage()); return False
    return True
  ...
  def pNext(self):
    ...
    except Exception as e: self.err("pDeposit_StrStr:", e); return None
    return result
