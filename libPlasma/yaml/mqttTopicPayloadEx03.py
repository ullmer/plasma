...
# Define topics
TOPIC_SENSE = "schoolroom1/sense/temperature"
TOPIC_ALERT = "forestgrid/alert/fire"
TOPIC_INTERACT = "classroom1/interact/token"
TOPIC_VISUALIZE = "classroom1/visualize/screens"
...
alert_payload = {
    ...
    "timestamp": "2025-06-07T20:35:00Z",
    "ack_required": True
}

interact_payload = {
    "user_id": "student_42",
    "device_id": "nfc_reader_1",
    "gesture": "token_swipe",
    "timestamp": "2025-06-07T20:40:00Z",
    "context": "lesson_navigation"
}

visualize_payload = {
    "source": "sensor_cluster_alpha",
    "mode": "timeline",
    "interactivity": True,
    "annotations": ["thresholds", "alerts"],
...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe(TOPIC_VISUALIZE)
