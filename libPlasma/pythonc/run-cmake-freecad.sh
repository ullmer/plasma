## Building plasma Python bindings for FreeCAD (macOS)

### Key constraints
- FreeCAD uses Python 3.11
- headers must come from MacPorts Python
- libpython must come from FreeCAD bundle
