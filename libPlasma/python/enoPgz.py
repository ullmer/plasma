# PyGame Zero Enodia extensions toward supporting multitouch, additional sensors and actuators, ++
# Brygg Ullmer, Clemson University
# Begun 2022-06-16
# Revisiting beginning 2024-07-17; think some of the pygame dependencies may have evolved
  ...
  def activateEventHandlers(self, eventHandlers):
    for eh in eventHandlers: 
      if eh not in self.EVENT_HANDLER_GENRES:
        print("enoPgz:activateEvenHandlers: unknown event handler requested:", eh)
        continue
      else:
        ehd = self.EVENT_HANDLER_GENRES[eh] # event handler dictionary
        print("enoPgz activateEventHandlers:", eh, ehd)
