...
class EnoTiledImg:
  ...
  imgTileQueue       = None
  maxImgTilesQueued  = 100 # picking 100 semi-arbitrarily.  I've seen 
                           # assertions that garbage collection will 
                           # auto-reclaim unreferenced pygame-loaded images.  
                           # This is an effort to cache but help
  imgTileCache       = None
  img2tileCoords     = None
  ...
  def draw(self, screen=None):
    ...
    if self.verbose: 
       print("draw", ix, iy, mx, my, "T", tx, ty, sx, sy, \
                     xtilesToDisplay, ytilesToDisplay)
